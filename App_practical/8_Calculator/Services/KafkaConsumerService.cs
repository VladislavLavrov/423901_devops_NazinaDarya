...
namespace calculator.Services
{
    ...
    public class KafkaConsumerService : BackgroundService
    {
        ...
        IServiceProvider serviceProvider, IHttpClientFactory
        clientFactory)
        {
            // Конфигурирование настроек Kafka и иници-ализация компонентов
        ...
        private async Task StartConsumerLoop(CancellationToken cancellationToken)
        {
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    // Заменить последние 2 цифры порта на порядковый номериз студенческого журнала.
        ...
        {
            _kafkaConsumer.Close(); // Фиксация оффсе-тов и корректное выход из группы.
